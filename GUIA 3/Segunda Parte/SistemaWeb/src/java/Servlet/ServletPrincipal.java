...
public class ServletPrincipal extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        }else if(accion.equals("RegistroLlegadas")){
            request.getRequestDispatcher("/RegistroLlegadas.html").forward(request, response);
        }else if(accion.equals("RegistroSalidas")){
            request.getRequestDispatcher("/RegistroSalidas.html").forward(request, response);
        }
    }
